 ...
 * @LastEditTime: 2026-09-22 17:03:40
 * @License: GPL 3.0
 */
#include <cstdint>
...
const char* SecurityModeToString(cpp_bus_driver::Bq27220::SecurityMode mode) {
  switch (mode) {
